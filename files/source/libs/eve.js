...
const eve = (()=> {
  ...
  // eve = {
  //   ...eve,
  //   // The key fetch to eve needs to be in an object.
  //   // This is because in an IIFE it is already global.
  ...
  const add = {
    ...
    JSFile (
      ...
      try {
        ...
        // Set file type.
        // (source.indexOf('.mjs') < 0)
        //   ? element.type = 'application/javascript'
        //   : element.type = 'module';

        element.type = 'application/javascript'
        
        // Fix browser file read errors.
        // if (element.type == 'module')
          // source = source.replace(".mjs", ".js");
        ...
        function func ()
        {
          ...
          // mod
          //   ? add.Module(mod, callback, errorCallback)
          //   : callback && callback();
    ...
    CSSFile (
      source,
      // ~~ Options object for the css compilers
      // options,
      callback,
      errorCallback,
    ) {
      // TODO: Add css compilers
      //   --: Compiler for sass
      //   --: Compiler for scss
